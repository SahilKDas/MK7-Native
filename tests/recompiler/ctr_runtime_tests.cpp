...
bus_write_u32(0x200,0x3a767273u);bus_write_u8(0x204,0);g_cpu.R[1]=0x200;runtime_swi(0x2d);assert(g_cpu.R[0]==0);const auto srv_handle=g_cpu.R[1];
 ...
 bus_write_u32(0x240,g_cpu.R[1]);g_cpu.R[0]=0xffffffffu;g_cpu.R[1]=0x240;g_cpu.R[2]=1;g_cpu.R[3]=0;g_cpu.R[4]=0xffffffffu;runtime_swi(0x25);assert(g_cpu.R[0]==0&&g_cpu.R[1]==0&&ctr_runtime_reschedule_requested());
 g_cpu.R[0]=0xffff8001u;g_cpu.R[1]=0x10001u;runtime_swi(0x3c);assert(g_cpu.R[0]==0&&g_cpu.R[1]==0&&g_cpu.R[2]==0);
 g_cpu.R[0]=0xffff8001u;runtime_swi(0x38);assert(g_cpu.R[0]==0);const auto resource_limit=g_cpu.R[1];bus_write_u32(0x250,1);g_cpu.R[0]=0x260;g_cpu.R[1]=resource_limit;g_cpu.R[2]=0x250;g_cpu.R[3]=1;runtime_swi(0x39);assert(g_cpu.R[0]==0&&bus_read_u32(0x260)==0x04000000u);runtime_swi(0x3a);assert(g_cpu.R[0]==0&&bus_read_u32(0x260)>=0x1000u);
