...
void runtime_swi(std::uint32_t) noexcept; void runtime_irq() noexcept; void runtime_exception_return(std::uint32_t) noexcept; void runtime_unimplemented_op(std::uint32_t,std::uint32_t) noexcept;
...
std::uint32_t runtime_rev(std::uint32_t) noexcept; std::uint32_t runtime_rev16(std::uint32_t) noexcept; std::uint32_t runtime_revsh(std::uint32_t) noexcept;
