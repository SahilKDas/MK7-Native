...
void runtime_coproc_write(std::uint8_t,std::uint8_t,std::uint8_t,std::uint8_t,std::uint8_t,std::uint32_t) noexcept; void runtime_coproc_cdp(std::uint8_t,std::uint8_t,std::uint8_t,std::uint8_t,std::uint8_t,std::uint8_t) noexcept;
std::uint32_t runtime_rev(std::uint32_t) noexcept; std::uint32_t runtime_uxtb(std::uint32_t,unsigned) noexcept; std::uint32_t runtime_uxth(std::uint32_t,unsigned) noexcept; std::uint32_t runtime_sxtb(std::uint32_t,unsigned) noexcept; std::uint32_t runtime_sxth(std::uint32_t,unsigned) noexcept; std::uint32_t runtime_rev16(std::uint32_t) noexcept; std::uint32_t runtime_revsh(std::uint32_t) noexcept;
std::uint32_t runtime_ldrex(std::uint32_t) noexcept; std::uint32_t runtime_strex(std::uint32_t,std::uint32_t) noexcept; void runtime_cps(bool,std::uint32_t) noexcept; void runtime_setend(bool) noexcept;
...
void arm_set_nzc_logic(std::uint32_t,std::uint32_t) noexcept; void arm_set_nzcv_add(std::uint32_t,std::uint32_t,std::uint32_t) noexcept; void arm_set_nzcv_sub(std::uint32_t,std::uint32_t,std::uint32_t) noexcept; void arm_set_nzcv_sbc(std::uint32_t,std::uint32_t,std::uint32_t,std::uint32_t) noexcept;
