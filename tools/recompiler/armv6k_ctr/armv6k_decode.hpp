...
enum class Op { Base, Rev, Rev16, Revsh, Ldrex, Strex, Ldrexh, Strexh, Ldrexd, Strexd, Uxtb, Uxth, Sxtb, Sxth, Cps, Setend, VfpLoadStore, Pkhbt, Usat, Uxtah, Sxtah, Uxtab, Udf };
