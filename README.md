...
### Why C++26?
The native runtime and generated game code use C++; Zig independently audits every generated byte-map and enforces the coverage gate. Two languages, one fail-closed pipeline.
...
- [x] First 0.5% reachable native function/byte-map gate (0.5023% verified)
