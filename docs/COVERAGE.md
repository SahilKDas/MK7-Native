...
- Reachable ARM instruction bytes mapped and compiled: 59,204 bytes
- Coverage: 1.0332%
- Recompiled functions registered: 442
- Byte-map rows: 14,801
